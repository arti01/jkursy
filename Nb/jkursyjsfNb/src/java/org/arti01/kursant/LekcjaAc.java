...
public class LekcjaAc implements Serializable {
    ...
    public String fotaKursantaLekcji() {
        ...
        if (getListaFot().indexOf(fotaKursant) - 1 < 0) {
            prev = false;
        } else {
            prev = true;
        }
