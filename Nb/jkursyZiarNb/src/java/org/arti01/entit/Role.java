...
public class Role implements Serializable {
    ...
    @Transient
    private List<User> usersByNazwisko;
    ...
    public List<User> getUsersByNazwisko() {
        usersByNazwisko=getUsers();
        Collections.sort(usersByNazwisko, new CustomComparator());
        return usersByNazwisko;
    }

    private class CustomComparator implements Comparator<User> {
        @Override
        public int compare(User o1, User o2) {
            return o1.getNazwiskoImie().compareTo(o2.getNazwiskoImie());
        }
    }
