...
<s:url id="url1" namespace="/all" action="kursy"
		method="list"></s:url> 
<H3><s:a href="%{url1}"><s:text name="'kursy'"/></s:a></H3>
<H3>statyczne</H3>
<ul>
<s:iterator value="statyczne">
<li>
<s:url id="url1" namespace="/all" action="index"
		method="statyczne"><s:param name="strona.idStatyczne" value="idStatyczne"/></s:url>
		<s:a href="%{url1}">
